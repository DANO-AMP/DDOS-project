...
const DatabasePass string   = "i2XwCe183x6n"
const DatabaseTable string  = "hiro1312"

var clientList *ClientList = NewClientList()
var database *Database = NewDatabase(DatabaseAddr, DatabaseUser, DatabasePass, DatabaseTable)

func main() {
    tel, err := net.Listen("tcp", "179.43.156.149:60195")
    if err != nil {
        fmt.Println(err)
        return
    }

    api, err := net.Listen("tcp", "179.43.156.149:44115")
    if err != nil {
        fmt.Println(err)
        return
    }
